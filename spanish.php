...
$LNG['welcome_desc'] = 'Compartir tu música, conectarte con artistas, explorar contenido nuevo';
$LNG['join_now'] = 'Únete ahora';
$LNG['learn_more'] = 'Aprende más';
$LNG['creators'] = 'Creadores';
$LNG['listeners'] = 'Oyentes';
$LNG['audience'] = 'Audiencia';
$LNG['organize'] = 'Organizar';
$LNG['featured'] = 'Destacados';
$LNG['popular'] = 'Popular';
$LNG['latest'] = 'Último';
$LNG['upload_desc'] = 'Sube tus sonidos, música, podcasts al mundo';
$LNG['audience_desc'] = 'Conéctese con nuestra comunidad y aumente su audiencia';
$LNG['statistics_desc'] = 'Conozca a su audiencia con estadísticas avanzadas';
$LNG['explore_desc'] = 'Explorar nuevas músicas, descubrir nuevas personas y participar con artistas';
$LNG['share_desc'] = 'Comparte tu música favorita con tus amigos en redes sociales';
$LNG['organize_desc'] = 'Crea listas de reproducción y organiza tu música de la forma que quieras';
...
$LNG['new_playlist'] = 'Crear nueva lista de reproducción';
$LNG['cancel'] = 'Cancelar';
$LNG['close'] = 'Cerca';
